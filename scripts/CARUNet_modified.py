...
def CARUNet_modified(input_size=(256, 256, 3), start_neurons=32, keep_prob=0.8, block_size=7):
    ...
    pool4 = MaxPooling2D((2, 2), data_format="channels_last")(conv4)
    ...
    # expansive path
    deconv4 = Conv2DTranspose(start_neurons * 2, (3, 3), strides=(2, 2), data_format="channels_last", padding="same")(convm)
    ...
    deconv3 = Conv2DTranspose(start_neurons * 2, (3, 3), strides=(2, 2), data_format="channels_last", padding="same")(uconv4)
    ...
    deconv2 = Conv2DTranspose(start_neurons * 2, (3, 3), strides=(2, 2), data_format="channels_last", padding="same")(uconv3)
    ...
    deconv1 = Conv2DTranspose(start_neurons * 1, (3, 3), strides=(2, 2), data_format="channels_last", padding="same")(uconv2)
